...
<body>
  ...
  <div class="text-center my-2">
    <h4 style="margin: 0; text-decoration: underline;">PERJANJIAN KERJA WAKTU TERTENTU</h4>
  ...
  <table class="m-2" style="width: 100%">
    <tr>
      <td class="text-center" style="width: 33%">
        ...
        <br>
        <br>
        <p>{{ $contractSetting->hr_name }}</p>
      </td>
      <td class="text-center" style="width: 33%">
        <p>{{ $contractSetting->position_1 }}</p>
        <br>
        <br>
        <br>
        <br>
        <br>
        <p>{{ $contractSetting->sign_1 }}</p>
      </td>
      <td class="text-center" style="width: 33%">
        <p>Karyawan</p>
        <br>
